...
public sealed record HaEntity
{
    ...
    public IReadOnlyDictionary<string, IReadOnlyDictionary<string, JsonElement>>? Options { get; init; }
    public IReadOnlyDictionary<string, JsonElement>? Capabilities { get; init; }
}
